  ...
  return (
    <>
      ...
      <LegalLayout title="Conditions Générales d'Utilisation (CGU)" lastUpdated="1er janvier 2025">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-digiqo-primary mb-4">5. Utilisation des services</h2>
          <ul className="space-y-2 text-gray-700">
            <li>✔ L'utilisateur s'engage à utiliser le site dans le respect des lois en vigueur.</li>
            <li>✔ Tout usage frauduleux (piratage, spam, diffusion de contenu illicite) est interdit.</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-digiqo-primary mb-4">9. Cookies</h2>
          <ul className="space-y-2 text-gray-700">
            <li>✔ Des cookies sont utilisés pour améliorer l'expérience utilisateur.</li>
            <li>✔ Vous pouvez gérer vos préférences via le bandeau de consentement.</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-digiqo-primary mb-4">11. Loi applicable et litiges</h2>
          <ul className="space-y-2 text-gray-700">
            <li>✔ Les présentes CGU sont soumises au droit français.</li>
            <li>✔ En cas de litige, compétence est attribuée aux tribunaux de Saint-Denis, La Réunion.</li>
          </ul>
        </section>
