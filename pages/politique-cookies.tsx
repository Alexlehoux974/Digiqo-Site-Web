        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 rounded-lg p-4">
              <h3 className="font-semibold text-digiqo-primary mb-2">✔ Cookies essentiels</h3>
              <p className="text-gray-700">
                Indispensables au bon fonctionnement du site (ex. connexion utilisateur, sécurisation des paiements).
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <h3 className="font-semibold text-digiqo-primary mb-2">✔ Cookies analytiques</h3>
              <p className="text-gray-700">
                Permettent de mesurer l'audience et les performances du site (ex. Google Analytics).
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <h3 className="font-semibold text-digiqo-primary mb-2">✔ Cookies marketing</h3>
              <p className="text-gray-700">
                Utilisés pour personnaliser les publicités et suivre l'efficacité des campagnes.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <h3 className="font-semibold text-digiqo-primary mb-2">✔ Cookies de réseaux sociaux</h3>
              <p className="text-gray-700">
