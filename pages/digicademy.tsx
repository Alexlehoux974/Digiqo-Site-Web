...
const categories = [
  ...
  { id: 'publicite', name: 'Publicité en ligne', icon: Megaphone, color: 'bg-gradient-to-r from-[#DA6530] to-[#8B1431]', count: 4 },
  { id: 'sites-web', name: 'Sites Web', icon: Code, color: 'bg-gradient-to-r from-[#199CB7] to-[#DA6530]', count: 3 },
  { id: 'community', name: 'Community Management', icon: Users, color: 'bg-gradient-to-r from-[#8B1431] to-[#199CB7]', count: 1 },
