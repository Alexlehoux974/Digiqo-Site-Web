...
export const HeroParallax = ({
  ...
  return (
    ...
    >
      ...
      {/* Beach logo mascot */}
      <div className="absolute bottom-48 right-2 md:bottom-[22rem] md:right-12 z-0 hero-logo-float">
        <Image
...
const LogoCard = ({ product }: { product: { title: string; thumbnail: any } }) => {
  return (
    <div className="h-24 w-[8rem] flex-shrink-0 group/product relative">
      ...
      <div className="absolute bottom-4 left-4 opacity-0 group-hover/product:opacity-100 text-white font-semibold text-lg transition-opacity duration-300">
        {product.title}
      </div>
    </div>
  )
    ...
    <div className="max-w-7xl relative mx-auto py-6 md:py-24 px-4 w-full left-0 top-0 z-20">
      ...
      <div className="flex flex-wrap gap-6 mt-12 text-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-white/80">4 Experts Certifiés <span className="font-bold text-white">Meta & Google Ads</span></span>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="mt-8 flex items-center gap-4 group">
        <div className="bg-white rounded-xl px-5 py-3 shadow-xl hover:shadow-2xl transition-all duration-300 group-hover:scale-105">
          <svg className="h-10 w-10" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <title>Meta</title>
            <path d="M6.897 4h-.024l-.031 2.615h.022c1.715 0 3.046 1.357 5.94 6.246l.175.297.012.02 1.62-2.438-.012-.019a48.763 48.763 0 00-1.098-1.716 28.01 28.01 0 00-1.175-1.629C10.413 4.932 8.812 4 6.896 4z" fill="url(#meta-0)"/>
            <path d="M6.873 4C4.95 4.01 3.247 5.258 2.02 7.17a4.352 4.352 0 00-.01.017l2.254 1.231.011-.017c.718-1.083 1.61-1.774 2.568-1.785h.021L6.896 4h-.023z" fill="url(#meta-1)"/>
            ...
            <path d="M2.807 12.264l-2.533-.6-.005.022c-.177.918-.267 1.851-.269 2.786v.023l2.598.233v-.023a12.591 12.591 0 01.21-2.44z" fill="url(#meta-3)"/>
            <path d="M2.677 15.537a5.462 5.462 0 01-.079-.813v-.022L0 14.468v.024a8.89 8.89 0 00.146 1.652l2.535-.585a4.106 4.106 0 01-.004-.022z" fill="url(#meta-4)"/>
            <path d="M3.27 16.89c-.284-.31-.484-.756-.589-1.328l-.004-.021-2.535.585.004.021c.192 1.01.568 1.85 1.106 2.487l.014.017 2.018-1.745a2.106 2.106 0 01-.015-.016z" fill="url(#meta-5)"/>
            ...
            <path d="M21.344 16.52l-.011.02c-.214.402-.519.67-.917.787l.778 2.462a3.493 3.493 0 00.438-.182 3.558 3.558 0 001.366-1.218l.044-.065.012-.02-1.71-1.784z" fill="url(#meta-9)"/>
            ...
            <path d="M18.309 16.515c-.55-.642-1.232-1.712-2.303-3.44l-1.396-2.336-.011-.02-1.62 2.438.012.02.989 1.668c.959 1.61 1.74 2.774 2.493 3.585l.016.016 1.834-1.914a2.353 2.353 0 01-.014-.017z" fill="url(#meta-12)"/>
            <defs>
