      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 pt-28 md:pt-36 pb-16 md:pb-24">
        ...
        <div className="text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-6 md:gap-8 text-sm">
            <a
              href="https://fr.trustpilot.com/review/digiqo.tech"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 hover:text-white transition-colors"
              aria-label="Note Trustpilot 4,7 sur 5 — 30 avis"
            >
          ...
          <div className="mt-10 flex items-start justify-center gap-3 md:gap-5">
            {[
              { name: 'Meta Ads', icon: <svg className="h-7 w-7 md:h-9 md:w-9" viewBox="0 0 24 24"><path d="M6.897 4h-.024l-.031 2.615h.022c1.715 0 3.046 1.357 5.94 6.246l.175.297.012.02 1.62-2.438-.012-.019a48.763 48.763 0 00-1.098-1.716 28.01 28.01 0 00-1.175-1.629C10.413 4.932 8.812 4 6.896 4z" fill="#0082FB"/><path d="M6.873 4C4.95 4.01 3.247 5.258 2.02 7.17l2.254 1.231c.718-1.083 1.61-1.774 2.568-1.785h.021L6.896 4h-.023z" fill="#0082FB"/><path d="M10.78 9.654c-1.528 2.35-2.454 3.825-2.454 3.825-2.035 3.2-2.739 3.917-3.871 3.917a1.545 1.545 0 01-1.186-.508l-2.017 1.744C2.01 19.518 3.058 20 4.356 20c1.963 0 3.374-.928 5.884-5.33l1.766-3.13a41.283 41.283 0 00-1.227-1.886z" fill="#0082FB"/><path d="M20.918 5.713C19.853 4.633 18.583 4 17.225 4c-1.432 0-2.637.787-3.723 1.944l1.382 1.24c.715-.747 1.408-1.12 2.176-1.12.826 0 1.6.39 2.27 1.075l1.589-1.425z" fill="#0082FB"/><path d="M23.998 14.125c-.06-3.467-1.27-6.566-3.064-8.396l-1.588 1.424c1.35 1.392 2.277 3.98 2.361 6.971h2.292z" fill="#0082FB"/><path d="M18.309 16.515c-.55-.642-1.232-1.712-2.303-3.44l-1.396-2.336-1.62 2.438.989 1.668c.959 1.61 1.74 2.774 2.493 3.585l1.834-1.914z" fill="#0082FB"/></svg> },
              { name: 'Google Ads', icon: <Image src="/Google_Ads_logo.svg.png" alt="Google Ads" width={80} height={32} className="h-7 md:h-9 w-auto" /> },
              { name: 'TikTok Ads', icon: <svg className="h-7 w-7 md:h-9 md:w-9" viewBox="0 0 24 24" fill="none"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.34-6.34V9.4a8.16 8.16 0 004.76 1.52V7.48a4.83 4.83 0 01-1-.79z" fill="#000"/></svg> },
              { name: 'YouTube Ads', icon: <svg className="h-7 w-7 md:h-9 md:w-9" viewBox="0 0 24 24" fill="none"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.546 12 3.546 12 3.546s-7.505 0-9.377.504A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.504 9.376.504 9.376.504s7.505 0 9.377-.504a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814z" fill="#FF0000"/><path d="M9.545 15.568V8.432L15.818 12l-6.273 3.568z" fill="#FFF"/></svg> },
              { name: 'LinkedIn Ads', icon: <svg className="h-7 w-7 md:h-9 md:w-9" viewBox="0 0 24 24" fill="none"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" fill="#0A66C2"/></svg> },
            ].map((platform, i) => (
              <div key={i} className="flex flex-col items-center gap-1.5 hover:scale-105 transition-all duration-300">
