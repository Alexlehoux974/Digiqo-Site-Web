        ...
        <div className="grid grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="relative bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 overflow-hidden">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="bg-white rounded-lg p-2 shadow-sm hover:shadow-md transition-shadow">
                <OptimizedImage src="/partenaires/LA-BOUCHERIE-1024x1024.webp" alt="La Boucherie" width={1024} height={1024} className="w-full h-8 object-contain" objectFit="contain" />
              </div>
              <div className="bg-white rounded-lg p-2 shadow-sm hover:shadow-md transition-shadow">
                <OptimizedImage src="/partenaires/BEAUVALLON-1024x1024.webp" alt="Beauvallon" width={1024} height={1024} className="w-full h-8 object-contain" objectFit="contain" />
              </div>
