  ...
  return (
    <section className="py-8 md:py-32 relative overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-digiqo-accent/10 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-digiqo-secondary/5 rounded-full blur-3xl"></div>
      </div>
