...
export const AnimatedMarqueeHero: React.FC<AnimatedMarqueeHeroProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute -bottom-16 md:-bottom-20 left-0 w-full h-1/3 md:h-2/5 [mask-image:linear-gradient(to_bottom,transparent,black_20%,black_80%,transparent)]">
        <motion.div
